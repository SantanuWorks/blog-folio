                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-10 mb-10 text-center md:text-left">
                    <div class="flex flex-col items-center md:items-start">
                        <div class="flex items-center space-x-2 mb-4 justify-center md:justify-start">
                            <i class="fas fa-feather-alt text-stone-900 dark:text-white text-base"></i>
                            <span @@click="currentPage = 'blog'; currentSection = 'lets-get-started'; setTimeout(() => document.getElementById('lets-get-started').scrollIntoView({behavior: 'smooth'}), 100)" class="font-serif text-xl font-bold text-stone-900 dark:text-white cursor-pointer">
                                Articles By Santanu
                            </span>
                        </div>
                    ...
                    <div class="flex flex-col items-center md:items-end md:text-right">
                        <h4 class="font-semibold text-stone-900 dark:text-white mb-4">
                            Legal
                        </h4>
                        <ul
                            class="grid grid-cols-1 md:grid-cols-2 lg:gap-x-10 gap-y-2 gap-x-6 text-sm text-gray-500 dark:text-gray-400 place-items-center md:place-items-end">
                            <li>
                                <a href="#" class="hover:text-stone-900 dark:hover:text-white transition hover:underline underline-offset-4 transition-transform hover:-translate-y-0.5">
                                    Privacy Policy
                                </a>
                            </li>
                            <li>
